...
int main() {
    ...
    cout << "Enter " << col_cyan << "\"Seneca Daily\"" << col_end << " and then " << col_cyan << "2019/12/12" << col_end
         << endl;
    cin >> p;
    ...
    cout << "Enter " << col_cyan << "24 " << col_end << "then " << col_cyan << "2444" << col_end << " and then "
         << col_cyan << "244" << col_end << endl;
...
void output(const char *value) {
    cout << endl
         << col_green << value << col_green << endl;
}

void message(const char *value) {
    cout << endl
         << col_yellow << value << col_end << endl;
}
